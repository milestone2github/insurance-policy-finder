...
// import { useNavigate } from 'react-router-dom';
// import type { RootState } from '../../store';
// import { resetExistingPolicyData, setAllExistingPolicyData, setExistingPolicyData } from '../../store/ExistingPolicySlice';
...
//     const policies = existingPolicy.existingPolicyData
//       ? Object.values(existingPolicy.existingPolicyData)
//       : [];
...
//               otherName: policy.otherName,
//               renewalDate: policy.renewalDate instanceof Date
//                 ? policy.renewalDate
//                 : new Date(policy.renewalDate),
...
//       );
//     }
//   }, [existingPolicy, dispatch, navigate]);
...
//   const handleNext = () => {
//     const formattedData = policyForm.reduce<{ [key: string]: PolicyData }>((acc, policy, index) => {
//       acc[`policy-${index + 1}`] = policy;
//       return acc;
//     }, {});
